                ...
                {isHovered && artist && (
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            {artist.bio && (
                                <div className={`text-gray-300 text-xs leading-relaxed space-y-1 ${artist.image ? 'pt-0' : 'my-2'}`}>
                                    {artist.bio.split('\n').map((line, index) => {
                            ...
                            {artist.image && !artist.bio && (
                                <p className="text-gray-400 text-xs italic pt-1 pb-2">No bio available.</p>
                            )}
                            {!artist.image && !artist.bio && !artist.socialLink && (
                                <p className="text-gray-400 text-xs italic">No additional details available.</p>
                            )}
                            {!artist.image && !artist.bio && artist.socialLink && (
                                <p className="text-gray-400 text-xs italic mt-2">No bio available.</p>
                            )}
                            {!artist.image && artist.bio && !artist.socialLink && (
                                <p className="text-gray-400 text-xs italic mt-2">No social link available.</p>
                            )}
                        </div>
                    </div>
                )}
