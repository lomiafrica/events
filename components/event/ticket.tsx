...
import { Calendar, Clock, MapPin, User, Mail, Phone, Ticket, Star, Music, Headphones } from "lucide-react"
...
export default function EventTicket({
    ...
    useEffect(() => {
        ...
        const nameHash = (firstName + lastName + ticketId).split("").reduce((a, b) => {
    ...
    const decorativeElements = [
        ...
        <div key="music" className="flex flex-col items-center justify-center relative">
            <Music className="h-8 w-8 text-pink-400 animate-bounce" style={{ animationDuration: "2s" }} />
            <Music
        ...
        <div key="vinyl" className="relative h-16 w-16 flex items-center justify-center">
            ...
            <div className="bg-gradient-to-b from-black via-gray-950 to-black rounded-md overflow-hidden shadow-2xl border border-gray-900 relative">
                ...
                <div className="bg-gradient-to-r from-gray-900 to-gray-800 py-3 px-5 flex justify-between items-center relative">
                    <div className="flex items-center">
                        <h1 className="text-2xl font-bold text-white tracking-wider">DJAOULI ENT.</h1>
                    </div>
                ...
                <div className="px-5 pt-5 pb-3">
                    <div className="bg-blue-700 py-2 px-3 inline-block rounded-sm transform -rotate-1 shadow-lg">
                        <h2 className="text-xl font-bold text-white uppercase">{eventName}</h2>
                    </div>
                </div>
                ...
                <div className="px-5 py-4">
                    ...
                    <div className="flex">
                        ...
                        <div className="ml-2 flex items-center justify-center w-20">{decorativeElements[decorativeElement]}</div>
                    </div>
                </div>

                {/* Footer */}
                <div className="px-5 py-2 bg-black border-t border-gray-900">
                    <p className="text-[10px] text-center text-gray-600 font-medium">MADE IN BABI • OFFICIAL TICKET</p>
                </div>
            </div>
        </div>
    )
