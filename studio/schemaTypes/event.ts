      ...
      of: [
        {
          ...
          fields: [
            ...
            },
            {
              ...
              description: "Unique identifier for API integration (e.g., early-bird, booking-table). Auto-generated from name if not specified.",
              validation: (Rule: Rule) => Rule.required(),
            },
            {
              name: "price",
            ...
            },
            {
               ...
               type: 'text',
               description: "Additional details, conditions (e.g., entry times, supplement info, package inclusions)."
            },
            {
              name: "stock",
           ...
           preview: {
            ...
            prepare({ title, price, stock, description, details }: { title: string, price: number, stock: number, description?: string, details?: string }) {
