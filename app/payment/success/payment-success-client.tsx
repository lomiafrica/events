...
export function PaymentSuccessClient({ purchaseId }: PaymentSuccessClientProps) {
                        ...
                        <CardContent className="space-y-6">
                            <div className="text-center text-gray-600 dark:text-gray-300">
                                ...
                                {purchaseId && (
                                    <p className="text-sm mt-2 font-mono bg-gray-100 dark:bg-gray-800 p-2 rounded">
                                        {t(currentLanguage, "paymentSuccess.orderId", { orderId: purchaseId })}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                                ...
                                <ul className="text-sm text-green-700 dark:text-green-300 space-y-1">
                                    <li>• {t(currentLanguage, "paymentSuccess.whatsNext.checkEmail")}</li>
                                    <li>• {t(currentLanguage, "paymentSuccess.whatsNext.presentTicket")}</li>
                                    <li>• {t(currentLanguage, "paymentSuccess.whatsNext.arriveEarly")}</li>
                                </ul>
                            </div>
