                        ...
                        <CardContent className="space-y-6">
                            <div className="text-center text-gray-600 dark:text-gray-300">
                                ...
                                {purchaseId && (
                                    <p className="text-sm mt-2 font-mono bg-gray-100 dark:bg-gray-800 p-2 rounded">
                                        {t(currentLanguage, "paymentCancel.orderId", { orderId: purchaseId })}
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg p-4">
                                ...
                                <ul className="text-sm text-orange-700 dark:text-orange-300 space-y-1">
                                    <li>• {t(currentLanguage, "paymentCancel.whatsNext.tryAgain")}</li>
                                    <li>• {t(currentLanguage, "paymentCancel.whatsNext.differentMethod")}</li>
                                    <li>• {t(currentLanguage, "paymentCancel.whatsNext.contactSupport")}</li>
                                </ul>
                            </div>
