...
export const metadata: Metadata = {
    title: "Terms and Conditions | Djaouli Entertainment",
    ...
    return (
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <main className="flex-grow container mx-auto px-4 sm:px-6 py-12 md:py-16">
                <article className="max-w-3xl mx-auto prose prose-zinc dark:prose-invert lg:prose-lg 
                ...
                >
                    ...
                    <p className="text-sm text-muted-foreground">
                        ...
                        <br />
                        {t(currentLanguage, 'termsPage.lastUpdated', { date: formattedDate })}
                    </p>
